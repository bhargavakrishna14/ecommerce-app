...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<SimpleError> handle(CustomerNotFoundException exp) {
        return ResponseEntity
                .status(HttpStatus.NOT_FOUND)
                .body(new SimpleError(exp.getMessage()));
    }
    ...
    public ResponseEntity<SimpleError> handleGeneric(Exception ex) {
        return ResponseEntity
                ...
                .body(new SimpleError("Something went wrong: " + ex.getMessage()));
    }
}
